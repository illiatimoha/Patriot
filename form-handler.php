...
$use_smtp = '0';
//$emailto = 'mishaivchenko21@gmail.com';
$emailto = 'product.business0@gmail.com'; 
...
//for crm
$success_url = "../spasibo/index.php?name=$name&phone=$phone&country=$country&product_price=$product_price&product_id=$product_id&product_name=$product_name&email=mail";
// Run server-side validation
function sendEmail($subject, $content, $emailto) {
	
	$from = "glamourshop.pp.ua";
	$response_sent = '';
